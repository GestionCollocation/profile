                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="apropos" type="text" class="form-control @error('apropos') is-invalid @enderror" name="apropos" value="{{ old('apropos') }}" required autocomplete="apropos" autofocus>
